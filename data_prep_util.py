...
class GenImageDataset(Dataset):
    ...
    def __init__(self, root_dir, dataset_type, model_type, transform=None, highfreq=False, nput_type='Tensor'):
        """
        Args:
    ...
    def __getitem__(self, idx):
        ...
        #JG: apply high frequency analysis
        if self.highfreq:
            image = self.highfreq(image)
